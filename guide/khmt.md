...
| **Hệ điều hành** | Most of the code you write is run by an operating system, so you should know how those interact. | [*Operating Systems: Three Easy Pieces*](https://pages.cs.wisc.edu/~remzi/OSTEP/), có thể đọc thêm [Các chuyên mục trong môn Hệ điều hành](os.md) | [CS537](https://www.youtube.com/playlist?list=PLzBbfbHQmjyuqBFJ8KpDdcvnLNkvPXbS-) |
...
| **Distributed Systems** | These days, *most* systems are distributed systems. | *Designing Data-Intensive Applications* by Martin Kleppmann | [MIT 6.824](https://www.youtube.com/playlist?list=PLrw6a1wE39_tb2fErI4-WkMbsvGQk9_UB) |

### Các khóa học khác

- [The Missing Semester of Your CS Education](https://missing.csail.mit.edu/)
- [Vim bí thuật](vim.md), à không chuyển qua dùng Helix điiiiiiiiiii.
